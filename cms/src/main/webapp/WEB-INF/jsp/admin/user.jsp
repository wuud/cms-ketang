    ...
    <div id="pager">
        ...
        <div class="btngroup pull-right">
            <a type="button" class="btn btn-default"
               href="${pageContext.request.contextPath}/admin/user/${roleId }?page=0">首页</a>
            <a type="button" class="btn btn-default"
               href="${pageContext.request.contextPath}/admin/user/${roleId }?page=${prevPage}">上一页</a>
            <a type="button" class="btn btn-default"
               href="${pageContext.request.contextPath}/admin/user/${roleId }?page=${nextPage}">下一页</a>
            <a type="button" class="btn btn-default"
               href="${pageContext.request.contextPath}/admin/user/${roleId }?page=${totalPages-1}">尾页</a>
        </div>
    </div>
</div>
<!-- 模态框 -->
