...
<nav class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        ...
        <div class="log_info">
            ...
            <a href="${pageContext.request.contextPath}/logout" class="pull-right"><i class="iconfont icon-tuichu"></i></a>
        </div>
    </div>
</nav>
<!-- 侧边栏 -->
<div id="sidle_bar">
    ...
    <div class="sidlebar_content navbar-fixed-bottom">
        <a href="#collapse_system" data-toggle="collapse"><i
                style="font-size: 16px" class="iconfont icon-hao"></i>系统设置</a>
        <ul id="collapse_system" class="collapse collapse_all">
            <li><a href="" data-iframesrc="admin/user/1"> <i
                    style="font-size: 16px" class="iconfont icon-jianhao"></i>用户管理
            </a></li>
        ...
        <ul id="collapse_vedio" class="collapse collapse_all">
            <li><a href=""><i style="font-size: 16px"
                              style="font-size: 16px" class="iconfont icon-jianhao"></i>用户管理</a></li>
            <li><a href=""><i style="font-size: 16px"
                              class="iconfont icon-jianhao"></i>用户管理</a></li>
            <li><a href=""><i style="font-size: 16px"
                              class="iconfont icon-jianhao"></i>用户管理</a></li>
            <li><a href=""><i style="font-size: 16px"
                              class="iconfont icon-jianhao"></i>用户管理</a></li>
        ...
        <a href="#collapse_res" data-toggle="collapse"><i
                style="font-size: 16px" class="iconfont icon-hao"></i>资料管理</a>
